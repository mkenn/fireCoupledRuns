...
#MCK: ? before it was lhc;
#MCK: because we're using the previous parameter dataframe?


# RHESSys Inputs
# MCK: as before in 1.1
# looks like no parameter variations here
# and are the default files manually generated for this?
# or is this the previous parameter values from the lhc tuning?
input_rhessys <- list()
...
# MCK: so same as that generated in 1.1?
input_preexisting_table <- OUTPUT_DIR_1_P300_TOP_PS
# MCK: yes, this is the "selected" parameter set
# written in 1.2
# so 1 parameter set for the canopies
